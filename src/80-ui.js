...
;(function (CO) {
  ...
  function step2() {
    ...
    bd.appendChild(el('div', { class: 'safe' },
      ...
      el('span', {}, 'This is the file that matters. It holds ',
        el('b', { text: 'client names, case numbers and phone numbers' }),
  ...
  function privacyBand() {
    ...
    return el('div', { class: 'privacy' }, el('div', { class: 'in' },
      ...
      el('p', { class: 'sub', text: 'Your case register carries client names, case numbers and phone numbers. Callover reads it inside your browser and sends it nowhere — because there is nowhere for it to be sent.' }),
      el('div', { class: 'specs' },
